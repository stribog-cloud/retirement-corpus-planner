...
| Simulations | Stress testing | Scenario Library, risk cone, heatmap, downside paths, Historical Backtest Lab (cohort success rate, worst/best cohort, P10/P50/P90 bands) |
...
| Surface | Purpose |
|---------|---------|
| Assumption Studio | Full model configuration with search, warning strips, and tax-law controls, including the Risk & Goals tab's withdrawal-rule selector and the household tab's planned lump-sum goals editor |
...
|---------|----------|------|--------|
| 1.3.0 | 4 | 2026-07-06 | Added the Historical Backtest Lab to the Simulations row, noted the Risk & Goals withdrawal-rule selector and planned lump-sum goals editor in Assumption Studio, and added a conservative note on pending CSV/PDF export coverage for the new v2.0.0 fields. |
